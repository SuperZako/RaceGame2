...
class Car {
    ...
    steerAngle = 0.0;  // actual front wheel steer angle (-maxSteer..maxSteer)
    inputs = new InputState(); //  State of inputs
    smoothSteer: boolean;
    safeSteer: boolean;
    stats: Stats;
     ...
     */
    applySmoothSteer(steerInput: number, dt: number) {
        var steer = 0;
    ...
    */
    applySafeSteer(steerInput: number) {
